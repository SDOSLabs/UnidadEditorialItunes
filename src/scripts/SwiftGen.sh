...
#Strings
"${PODS_ROOT}/SwiftGen/bin/swiftgen" strings --templateName structured-swift4 "${SRCROOT}/main/resources/localizable/es.lproj/" --output "${SRCROOT}/main/resources/generated/Strings.generated.swift"
#Assets
